...
const ENV_FIELDS: { key: string; label: string; secret?: boolean }[] = [
  ...
  { key: 'TRELLIS2_DECIMATION', label: 'TRELLIS2_DECIMATION (300k, не 1M)' },
  ...
  { key: 'TRELLIS2_MULTI_IMAGE_MODE', label: 'TRELLIS2_MULTI_IMAGE_MODE (multidiffusion|stochastic)' },
  ...
  { key: 'TRELLIS2_HOLE_ITERATIONS', label: 'TRELLIS2_HOLE_ITERATIONS (5)' },
  { key: 'TRELLIS2_AUTO_HOLE_FILL', label: 'TRELLIS2_AUTO_HOLE_FILL (1=auto for 3+ photos)' },
