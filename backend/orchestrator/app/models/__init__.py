...
class User(Base):
    ...
    preferred_locale: Mapped[str] = mapped_column(String(10), default="ru")
    gender: Mapped[str | None] = mapped_column(String(20))
    region: Mapped[str | None] = mapped_column(String(128))
    card_bank_issuer: Mapped[str | None] = mapped_column(String(255))
...
class AutoscalingRule(Base):
    ...
    is_active: Mapped[bool] = mapped_column(Boolean, default=True)
    auto_launch: Mapped[bool] = mapped_column(Boolean, default=False)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
